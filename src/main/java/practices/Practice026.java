...
public class Practice026 {
    public static void main(String[] args) {
        ...
        //nは漢字のみに限る
        System.out.println(getResearchPrefectureName(prefectureName47, "石"));
    }

    public static List<String> getResearchPrefectureName(List<String> prefectureName47, String n) {
        return prefectureName47.stream()
