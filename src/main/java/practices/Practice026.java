...
public class Practice026 {
    public static void main(String[] args) {
        ...
        System.out.println("検索結果："+searchPre(prefecturesList, searchWord));

    }

    public static List<String> searchPre(List<String> preList, String order) {

        ArrayList<String> search = new ArrayList<>();
        preList.stream()
                .filter(i -> i.contains(order))
                .forEach(i -> search.add(i));
//        System.out.println("検索結果："+ search); //一応確認のため表示
        return search;
