...
public class Practice024 {
    ...
    public static List<String> prefecture(ArrayList<String> arrayPrefecture, String checkPrefecture) {
        ...
        for (int i = 0; i < arrayPrefecture.size(); i++) {
            if (arrayPrefecture.get(i).endsWith(checkPrefecture)) {
                returnPrefecture.add(arrayPrefecture.get(i));
            }
        }
...
public static List<String> prefecture(ArrayList<String> arrayPrefecture,String checkPrefecture){
        ...
        for(int i=0;i<arrayPrefecture.size();i++){
        if(arrayPrefecture.get(i).contains("都")){
        to.add(arrayPrefecture.get(i));
        }else if(arrayPrefecture.get(i).contains("道")){
        dou.add(arrayPrefecture.get(i));
        }else if(arrayPrefecture.get(i).contains("府")){
        hu.add(arrayPrefecture.get(i));
        }else{
        ken.add(arrayPrefecture.get(i));
        }
        }
        return to;
        }
